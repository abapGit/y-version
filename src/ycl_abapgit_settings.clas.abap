CLASS ycl_abapgit_settings DEFINITION PUBLIC CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS:
      ...
      get_user_settings
        RETURNING
          VALUE(rs_settings) TYPE yif_abapgit_definitions=>ty_s_user_settings
        RAISING
          ycx_abapgit_exception,
      set_xml_settings
        IMPORTING
      ...
      set_user_settings
        IMPORTING
          is_user_settings TYPE yif_abapgit_definitions=>ty_s_user_settings,
      ...
      set_hotkeys
        IMPORTING
          it_hotkeys TYPE yif_abapgit_definitions=>tty_hotkey,
      get_hotkeys
        RETURNING
  ...
  PRIVATE SECTION.
    ...
    DATA: ms_settings      TYPE ty_s_settings,
          ms_user_settings TYPE yif_abapgit_definitions=>ty_s_user_settings.
...
CLASS ycl_abapgit_settings IMPLEMENTATION.
  ...
  METHOD get_settings_xml.
    ...
    DATA: lo_output TYPE REF TO ycl_abapgit_xml_output.


    CREATE OBJECT lo_output.

    lo_output->add( iv_name = ycl_abapgit_persistence_db=>c_type_settings
                    ig_data = ms_settings ).
  ...
  METHOD set_xml_settings.
    ...
    DATA: lo_input TYPE REF TO ycl_abapgit_xml_input.
    ...
    lo_input->read(
      EXPORTING
        iv_name = ycl_abapgit_persistence_db=>c_type_settings
      CHANGING
        cg_data = ms_settings ).
  ...
  METHOD get_hotkeys.
    ...
    DATA: lt_default_hotkeys TYPE yif_abapgit_gui_page_hotkey=>tty_hotkey_action,
    ...
    ELSE.
      ...
      lt_default_hotkeys = ycl_abapgit_hotkeys=>get_default_hotkeys_from_pages( ).
