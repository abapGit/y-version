...
CLASS ycx_abapgit_exception DEFINITION LOCAL FRIENDS ltcl_test.
...
CLASS ltcl_test IMPLEMENTATION.
  METHOD test_direct_text.
    ...
    DATA: lx_ex       TYPE REF TO ycx_abapgit_exception,
    ...
    TRY.
        ...
        ycx_abapgit_exception=>raise( iv_text     = lx_previous->get_text( )
                                      ix_previous = lx_previous ).
        cl_abap_unit_assert=>fail( ).

      CATCH ycx_abapgit_exception INTO lx_ex.
    ...
    TRY.
        ycx_abapgit_exception=>raise( lc_text1 ).
        cl_abap_unit_assert=>fail( ).
      CATCH ycx_abapgit_exception INTO lx_ex.
    ...
    TRY.
        ycx_abapgit_exception=>raise( lc_text2 ).
        cl_abap_unit_assert=>fail( ).
      CATCH ycx_abapgit_exception INTO lx_ex.
        cl_abap_unit_assert=>assert_equals(
          act = get_exc_text( lx_ex )
          exp = ycx_abapgit_exception=>gc_generic_error_msg ).
    ENDTRY.
  ...
  METHOD test_no_text.
    ...
    TRY.
        ycx_abapgit_exception=>raise( space ).
        cl_abap_unit_assert=>fail( ).
      CATCH ycx_abapgit_exception INTO lx_ex.
        cl_abap_unit_assert=>assert_equals(
          act = get_exc_text( lx_ex )
