CLASS ycl_abapgit_longtexts DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
    ...
    CLASS-METHODS:
      serialize
        IMPORTING
          ...
          it_dokil       TYPE yif_abapgit_definitions=>tty_dokil
...
CLASS YCL_ABAPGIT_LONGTEXTS IMPLEMENTATION.


  METHOD delete.

    DATA: lt_dokil TYPE yif_abapgit_definitions=>tty_dokil.
  ...
  METHOD serialize.
    ...
    ELSE.
      ...
      ycx_abapgit_exception=>raise( |serialize_longtexts parameter error| ).
