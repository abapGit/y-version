CLASS ycl_abapgit_persist_background DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_xml,
             ...
             settings TYPE yif_abapgit_background=>ty_settings_tt,
           END OF ty_xml.

    TYPES: BEGIN OF ty_background,
             key TYPE yif_abapgit_persistence=>ty_value.
        INCLUDE TYPE ty_xml.
...
CLASS YCL_ABAPGIT_PERSIST_BACKGROUND IMPLEMENTATION.
  ...
  METHOD delete.
    ...
    TRY.
        mo_db->read( iv_type  = ycl_abapgit_persistence_db=>c_type_background
                     iv_value = iv_key ).
      CATCH ycx_abapgit_not_found.
        RETURN.
    ENDTRY.

    mo_db->delete( iv_type  = ycl_abapgit_persistence_db=>c_type_background
                   iv_value = iv_key ).
  ...
  METHOD list.
    ...
    DATA: lt_list TYPE yif_abapgit_persistence=>tt_content,
          ls_xml  TYPE ty_xml.
    ...
    lt_list = mo_db->list_by_type( ycl_abapgit_persistence_db=>c_type_background ).
  ...
  METHOD modify.
    ...
    mo_db->modify(
      iv_type  = ycl_abapgit_persistence_db=>c_type_background
