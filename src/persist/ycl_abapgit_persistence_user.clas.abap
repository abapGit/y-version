CLASS ycl_abapgit_persistence_user DEFINITION
  PUBLIC
  CREATE PRIVATE .

  PUBLIC SECTION.

    INTERFACES yif_abapgit_persist_user .

    TYPES tt_favorites TYPE yif_abapgit_persistence=>tt_repo_keys .

    CLASS-METHODS get_instance
      IMPORTING
        !iv_user       TYPE xubname DEFAULT sy-uname
      RETURNING
        VALUE(ri_user) TYPE REF TO yif_abapgit_persist_user .
  PRIVATE SECTION.

    TYPES:
      BEGIN OF ty_repo_config,
        url              TYPE yif_abapgit_persistence=>ty_repo-url,
        login            TYPE string,
        git_user         TYPE yif_abapgit_definitions=>ty_git_user,
    ...
    TYPES:
      BEGIN OF ty_user,
        default_git_user TYPE yif_abapgit_definitions=>ty_git_user,
        repo_show        TYPE yif_abapgit_persistence=>ty_repo-key,
        hide_files       TYPE abap_bool,
        changes_only     TYPE abap_bool,
        diff_unified     TYPE abap_bool,
        favorites        TYPE tt_favorites,
        repo_config      TYPE ty_repo_config_tt,
        settings         TYPE yif_abapgit_definitions=>ty_s_user_settings,
      END OF ty_user .

    DATA mv_user TYPE xubname .
    CLASS-DATA gi_current_user TYPE REF TO yif_abapgit_persist_user .
...
CLASS YCL_ABAPGIT_PERSISTENCE_USER IMPLEMENTATION.
...
* fix downward compatibility
  ...
  METHOD get_instance.
    ...
    IF iv_user = sy-uname ##USER_OK.
      IF gi_current_user IS NOT BOUND.
        CREATE OBJECT gi_current_user TYPE ycl_abapgit_persistence_user.
      ENDIF.
      ri_user = gi_current_user.
    ELSE.
      CREATE OBJECT ri_user TYPE ycl_abapgit_persistence_user
        EXPORTING
          iv_user = iv_user.
    ENDIF.
  ...
  METHOD read.
    ...
    TRY.
        lv_xml = ycl_abapgit_persistence_db=>get_instance( )->read(
          iv_type  = ycl_abapgit_persistence_db=>c_type_user
          iv_value = mv_user ).
  ...
  METHOD yif_abapgit_persist_user~get_changes_only.
  ...
  METHOD yif_abapgit_persist_user~get_default_git_user_email.
  ...
  METHOD yif_abapgit_persist_user~get_default_git_user_name.
  ...
  METHOD yif_abapgit_persist_user~get_diff_unified.
  ...
  METHOD yif_abapgit_persist_user~get_favorites.
  ...
  METHOD yif_abapgit_persist_user~get_hide_files.
  ...
  METHOD yif_abapgit_persist_user~get_repo_git_user_email.
  ...
  METHOD yif_abapgit_persist_user~get_repo_git_user_name.
  ...
  METHOD yif_abapgit_persist_user~get_repo_last_change_seen.
  ...
  METHOD yif_abapgit_persist_user~get_repo_login.
  ...
  METHOD yif_abapgit_persist_user~get_repo_show.
  ...
  METHOD yif_abapgit_persist_user~get_settings.
  ...
  METHOD yif_abapgit_persist_user~is_favorite_repo.

    DATA: lt_favorites TYPE tt_favorites.

    lt_favorites = yif_abapgit_persist_user~get_favorites( ).
  ...
  METHOD yif_abapgit_persist_user~set_default_git_user_email.
  ...
  METHOD yif_abapgit_persist_user~set_default_git_user_name.
  ...
  METHOD yif_abapgit_persist_user~set_repo_git_user_email.
  ...
  METHOD yif_abapgit_persist_user~set_repo_git_user_name.
  ...
  METHOD yif_abapgit_persist_user~set_repo_last_change_seen.
  ...
  METHOD yif_abapgit_persist_user~set_repo_login.
  ...
  METHOD yif_abapgit_persist_user~set_repo_show.
  ...
  METHOD yif_abapgit_persist_user~set_settings.
  ...
  METHOD yif_abapgit_persist_user~toggle_changes_only.
  ...
  METHOD yif_abapgit_persist_user~toggle_diff_unified.
  ...
  METHOD yif_abapgit_persist_user~toggle_favorite.
  ...
  METHOD yif_abapgit_persist_user~toggle_hide_files.
