INTERFACE yif_abapgit_persist_user
  PUBLIC .
  ...
  METHODS is_favorite_repo
    IMPORTING
      !iv_repo_key  TYPE yif_abapgit_persistence=>ty_repo-key
    RETURNING
  ...
  METHODS get_settings
    RETURNING
      VALUE(rs_user_settings) TYPE yif_abapgit_definitions=>ty_s_user_settings
    RAISING
      ycx_abapgit_exception.
