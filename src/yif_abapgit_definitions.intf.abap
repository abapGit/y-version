INTERFACE yif_abapgit_definitions PUBLIC.
  ...
  TYPES: ty_repo_ref_tt TYPE STANDARD TABLE OF REF TO ycl_abapgit_repo WITH DEFAULT KEY.
  ...
  TYPES:
    BEGIN OF ty_git_tag,
      sha1         TYPE yif_abapgit_definitions=>ty_sha1,
      object       TYPE yif_abapgit_definitions=>ty_sha1,
      name         TYPE string,
      type         TYPE ty_git_branch_type,
      display_name TYPE string,
  ...
  TYPES:
    BEGIN OF ty_file_item,
      file TYPE yif_abapgit_definitions=>ty_file,
      item TYPE ty_item,
    END OF ty_file_item .
  TYPES:
  ...
  TYPES:
    BEGIN OF ty_stage_files,
      local  TYPE yif_abapgit_definitions=>ty_files_item_tt,
      remote TYPE yif_abapgit_definitions=>ty_files_tt,
  ...
  TYPES:
    BEGIN OF ty_object,
      sha1    TYPE yif_abapgit_definitions=>ty_sha1,
      type    TYPE yif_abapgit_definitions=>ty_type,
      data    TYPE xstring,
  ...
  TYPES: BEGIN OF ty_merge,
           repo     TYPE REF TO ycl_abapgit_repo_online,
           ...
           stage    TYPE REF TO ycl_abapgit_stage,
  ...
  TYPES: BEGIN OF ty_merge_conflict,
           path        TYPE string,
           filename    TYPE string,
           source_sha1 TYPE yif_abapgit_definitions=>ty_sha1,
           source_data TYPE xstring,
           target_sha1 TYPE yif_abapgit_definitions=>ty_sha1,
           target_data TYPE xstring,
           result_sha1 TYPE yif_abapgit_definitions=>ty_sha1,
  ...
  CONSTANTS:
    BEGIN OF c_type,
      commit TYPE yif_abapgit_definitions=>ty_type VALUE 'commit', "#EC NOTEXT
      tree   TYPE yif_abapgit_definitions=>ty_type VALUE 'tree', "#EC NOTEXT
      ref_d  TYPE yif_abapgit_definitions=>ty_type VALUE 'ref_d', "#EC NOTEXT
      tag    TYPE yif_abapgit_definitions=>ty_type VALUE 'tag', "#EC NOTEXT
      blob   TYPE yif_abapgit_definitions=>ty_type VALUE 'blob', "#EC NOTEXT
    END OF c_type .
  CONSTANTS:
