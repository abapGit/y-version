...
CLASS simple_dependency_injection IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    ycl_abapgit_injector=>set_tadir( lo_tadir_mock ).
  ...
  METHOD simple_injection.
    ...
    cl_abap_unit_assert=>assert_equals(
      exp = '\CLASS-POOL=YCL_ABAPGIT_INJECTOR\CLASS=LTD_ABAPGIT_TADIR_MOCK'
      act = lo_class_descr->absolute_name ).
