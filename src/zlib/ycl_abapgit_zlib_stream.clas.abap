CLASS ycl_abapgit_zlib_stream DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS YCL_ABAPGIT_ZLIB_STREAM IMPLEMENTATION.
  ...
  METHOD take_bits.
    ...
    WHILE strlen( rv_bits ) < iv_length.
      IF mv_bits IS INITIAL.
        ...
        mv_bits = ycl_abapgit_zlib_convert=>hex_to_bits( lv_x ).
  ...
  METHOD take_int.
    ...
    rv_int = ycl_abapgit_zlib_convert=>bits_to_int( take_bits( iv_length ) ).
