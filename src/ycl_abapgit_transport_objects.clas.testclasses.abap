...
CLASS ltcl_transport_objects DEFINITION FOR TESTING DURATION SHORT RISK LEVEL HARMLESS.
  ...
  PRIVATE SECTION.
    METHODS:
      ...
      given_the_local_file
        IMPORTING iv_obj_name          TYPE string
                  ...
                  iv_path              TYPE string
                  iv_data              TYPE string
        RETURNING VALUE(rs_local_file) TYPE yif_abapgit_definitions=>ty_file_item,
      when_staging
        RAISING ycx_abapgit_exception,
      then_file_should_be_added
        IMPORTING
          is_local_file TYPE yif_abapgit_definitions=>ty_file_item,
    ...
    DATA: mo_transport_objects TYPE REF TO ycl_abapgit_transport_objects,
          mt_transport_objects TYPE yif_abapgit_definitions=>ty_tadir_tt,
          mt_object_statuses   TYPE yif_abapgit_definitions=>ty_results_tt,
          ms_stage_objects     TYPE yif_abapgit_definitions=>ty_stage_files,
...
CLASS ltcl_transport_objects IMPLEMENTATION.
  ...
  METHOD add_new_to_local_files.
    DATA ls_local_file TYPE yif_abapgit_definitions=>ty_file_item.
    ...
    given_the_object_status(
      ...
      iv_lstate     = yif_abapgit_definitions=>c_state-added ).
  ...
  METHOD modified_to_new_local_files.
    ...
    given_the_object_status(
      ...
      iv_obj_type   = 'CLAS'
      iv_filename   = 'CL_FOO.abap'
      iv_lstate     = yif_abapgit_definitions=>c_state-modified ).
  ...
  METHOD should_add_all_local_files.
    ...
    DATA ls_abap_local_file TYPE yif_abapgit_definitions=>ty_file_item.
    DATA ls_xml_local_file  TYPE yif_abapgit_definitions=>ty_file_item.
  ...
  METHOD deleted_to_removed_files.
    ...
    given_the_object_status(
      ...
      iv_filename   = 'CL_FOO.abap'
      iv_path       = '/a_path'
      iv_lstate     = yif_abapgit_definitions=>c_state-deleted ).
  ...
  METHOD given_the_transport_object.
    DATA ls_transport_object TYPE yif_abapgit_definitions=>ty_tadir.
  ...
  METHOD given_the_object_status.
    DATA ls_object_status TYPE yif_abapgit_definitions=>ty_result.
  ...
  METHOD then_file_should_be_added.
    DATA: lt_staged_objects TYPE ycl_abapgit_stage=>ty_stage_tt.
    ...
    WITH KEY file-filename = is_local_file-file-filename
            ...
            method         = ycl_abapgit_stage=>c_method-add.
    IF sy-subrc <> 0.
