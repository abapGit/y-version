CLASS ycl_abapgit_gui_page DEFINITION PUBLIC ABSTRACT CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES:
      yif_abapgit_gui_page.
  ...
  PROTECTED SECTION.
    ...
    TYPES: BEGIN OF ty_control,
             ...
             page_menu    TYPE REF TO ycl_abapgit_html_toolbar,
           END OF  ty_control.
...
CLASS ycl_abapgit_gui_page IMPLEMENTATION.
  ...
  METHOD add_hotkeys.
    ...
    lt_hotkeys = ycl_abapgit_hotkeys=>get_relevant_hotkeys_for_page( me ).
  ...
  METHOD footer.
    ...
    ro_html->add( |<td><span class="version">{ yif_abapgit_version=>gc_abap_version }</span></td>| ). "#EC NOTEXT
  ...
  METHOD html_head.
    ...
    ro_html->add( ycl_abapgit_gui_asset_manager=>get_webfont_link( ) ). " Web fonts
  ...
  METHOD render_hotkey_overview.
    ...
    CREATE OBJECT ro_html.
    ro_html->add( ycl_abapgit_gui_chunk_lib=>render_hotkey_overview( ) ).
  ...
  METHOD title.
    ...
    ro_html->add( |<td class="logo">{
                  ycl_abapgit_html=>a( iv_txt = '<img src="img/logo" alt="logo">'
                                       iv_id  = 'abapGitLogo'
                                       iv_act = yif_abapgit_definitions=>c_action-abapgit_home )
                  }</td>| ).                                "#EC NOTEXT
  ...
  METHOD yif_abapgit_gui_page~on_event.
    ...
    CASE iv_action.
      WHEN yif_abapgit_definitions=>c_action-url.
  ...
  METHOD yif_abapgit_gui_page~render.
    ...
    DATA lo_script TYPE REF TO ycl_abapgit_html.
