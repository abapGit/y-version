CLASS ycl_abapgit_html DEFINITION
  PUBLIC
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS add_a
      IMPORTING
        !iv_txt   TYPE string
        !iv_act   TYPE string
        !iv_typ   TYPE char1 DEFAULT yif_abapgit_definitions=>c_action_type-sapevent
...
CLASS YCL_ABAPGIT_HTML IMPLEMENTATION.
  ...
  METHOD a.
    ...
    IF iv_opt CA yif_abapgit_definitions=>c_html_opt-strong.
      lv_class = lv_class && ' emphasis' ##NO_TEXT.
    ENDIF.
    IF iv_opt CA yif_abapgit_definitions=>c_html_opt-cancel.
      lv_class = lv_class && ' attention' ##NO_TEXT.
    ENDIF.
    IF iv_opt CA yif_abapgit_definitions=>c_html_opt-crossout.
    ...
    IF iv_act IS NOT INITIAL OR iv_typ = yif_abapgit_definitions=>c_action_type-dummy.
      CASE iv_typ.
        WHEN yif_abapgit_definitions=>c_action_type-url.
          lv_href  = | href="{ iv_act }"|.
        WHEN yif_abapgit_definitions=>c_action_type-sapevent.
          lv_href  = | href="sapevent:{ iv_act }"|.
        WHEN yif_abapgit_definitions=>c_action_type-onclick.
          lv_href  = ' href="#"'.
          lv_click = | onclick="{ iv_act }"|.
        WHEN yif_abapgit_definitions=>c_action_type-dummy.
          lv_href  = ' href="#"'.
      ENDCASE.
    ENDIF.
  ...
  METHOD render.
    ...
    CONCATENATE LINES OF lt_temp INTO rv_html SEPARATED BY yif_abapgit_definitions=>c_newline.
