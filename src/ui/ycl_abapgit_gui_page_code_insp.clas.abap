CLASS ycl_abapgit_gui_page_code_insp DEFINITION PUBLIC FINAL CREATE PUBLIC
...
CLASS ycl_abapgit_gui_page_code_insp IMPLEMENTATION.
  ...
  METHOD build_menu.
    ...
    IF is_stage_allowed( ) = abap_false.
      lv_opt = yif_abapgit_definitions=>c_html_opt-crossout.
    ENDIF.
    ...
    CASE iv_action.
      WHEN c_actions-stage.
        ...
        IF is_stage_allowed( ) = abap_true.
          ...
          CREATE OBJECT ei_page TYPE ycl_abapgit_gui_page_stage
            EXPORTING
  ...
  METHOD yif_abapgit_gui_page~render.
    ...
    ro_html = super->yif_abapgit_gui_page~render( ).
