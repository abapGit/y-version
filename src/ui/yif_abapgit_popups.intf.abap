INTERFACE yif_abapgit_popups
  ...
  METHODS repo_new_offline
    RETURNING
      VALUE(rs_popup) TYPE yif_abapgit_popups=>ty_popup
    RAISING
      ycx_abapgit_exception .
  ...
  METHODS popup_to_create_transp_branch
    ...
    RETURNING
      VALUE(rs_transport_branch) TYPE yif_abapgit_definitions=>ty_transport_to_branch
    RAISING
      ycx_abapgit_exception
      ycx_abapgit_cancel .
  ...
  METHODS branch_popup_callback
    IMPORTING
      !iv_code       TYPE clike
    CHANGING
      !ct_fields     TYPE yif_abapgit_definitions=>ty_sval_tt
      !cs_error      TYPE svale
  ...
  METHODS popup_transport_request
    IMPORTING
      !is_transport_type  TYPE yif_abapgit_definitions=>ty_transport_type
    RETURNING
