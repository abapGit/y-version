CLASS ycl_abapgit_gui_page_commit DEFINITION
  PUBLIC
...
CLASS YCL_ABAPGIT_GUI_PAGE_COMMIT IMPLEMENTATION.
...
* body should wrap at 72 characters
  ...
  METHOD render_stage.
    ...
    DATA: lt_stage TYPE ycl_abapgit_stage=>ty_stage_tt.
    ...
    LOOP AT lt_stage ASSIGNING <ls_stage>.
      ...
      ro_html->add( ycl_abapgit_stage=>method_description( <ls_stage>-method ) ).
      ro_html->add( '</td>' ).
      ro_html->add( '<td>' ).
  ...
  METHOD yif_abapgit_gui_page~on_event.
    ...
    DATA: ls_commit TYPE ycl_abapgit_services_git=>ty_commit_fields.
    ...
    CASE iv_action.
      WHEN c_action-commit_post.
        ...
        ycl_abapgit_services_git=>commit( is_commit   = ls_commit
                                  io_repo     = mo_repo
                                  io_stage    = mo_stage ).

        ev_state = yif_abapgit_definitions=>c_event_state-go_back_to_bookmark.
