CLASS ycl_abapgit_html_action_utils DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS file_obj_decode
      IMPORTING
        !iv_string TYPE clike
      EXPORTING
        !ev_key    TYPE yif_abapgit_persistence=>ty_repo-key
    ...
    CLASS-METHODS dbkey_decode
      IMPORTING
        !iv_string    TYPE clike
      RETURNING
        VALUE(rs_key) TYPE yif_abapgit_persistence=>ty_content .
...
CLASS ycl_abapgit_html_action_utils IMPLEMENTATION.
