CLASS ycl_abapgit_gui_page_merge DEFINITION
  PUBLIC
...
CLASS ycl_abapgit_gui_page_merge IMPLEMENTATION.
  ...
  METHOD render_content.
    ...
    DATA: ls_merge  TYPE yif_abapgit_definitions=>ty_merge,
    ...
    CASE iv_action.
      WHEN c_actions-merge.
        IF mo_merge->has_conflicts( ) EQ abap_true.
          ycx_abapgit_exception=>raise( 'conflicts exists' ).
        ENDIF.

        IF mo_merge->get_result( )-stage->count( ) EQ 0.
          ycx_abapgit_exception=>raise( 'nothing to merge' ).
        ENDIF.
      ...
      WHEN c_actions-res_conflicts.
        ...
        CREATE OBJECT ei_page TYPE ycl_abapgit_gui_page_merge_res
          EXPORTING
            io_repo       = mo_repo
            io_merge_page = me
            io_merge      = mo_merge.
