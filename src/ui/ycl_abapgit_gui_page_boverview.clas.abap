CLASS ycl_abapgit_gui_page_boverview DEFINITION
  PUBLIC
  FINAL
  ...
  PRIVATE SECTION.
    DATA: mo_repo            TYPE REF TO ycl_abapgit_repo_online,
          ...
          mt_commits         TYPE yif_abapgit_definitions=>ty_commit_tt,
          mi_branch_overview TYPE REF TO yif_abapgit_branch_overview.
...
CLASS ycl_abapgit_gui_page_boverview IMPLEMENTATION.
...
* assumption: all branches are created from master, todo
      ...
      LOOP AT <ls_commit>-create ASSIGNING <ls_create>.
        IF <ls_create>-name CS ycl_abapgit_branch_overview=>c_deleted_branch_name_prefix.
  ...
  METHOD refresh.
    ...
    mi_branch_overview = ycl_abapgit_factory=>get_branch_overview( mo_repo ).
  ...
  METHOD yif_abapgit_gui_page~on_event.
    ...
    DATA: ls_merge TYPE ty_merge,
          lo_merge TYPE REF TO ycl_abapgit_gui_page_merge.
