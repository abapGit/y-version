CLASS ycl_abapgit_gui DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS: get_instance
      RETURNING VALUE(ro_gui) TYPE REF TO ycl_abapgit_gui
  ...
  PRIVATE SECTION.
    ...
    CLASS-DATA: go_gui TYPE REF TO ycl_abapgit_gui.

    TYPES: BEGIN OF ty_page_stack,
             page     TYPE REF TO yif_abapgit_gui_page,
             bookmark TYPE abap_bool,
           END OF ty_page_stack.

    DATA: mi_cur_page    TYPE REF TO yif_abapgit_gui_page,
          mt_stack       TYPE STANDARD TABLE OF ty_page_stack,
          mo_router      TYPE REF TO ycl_abapgit_gui_router,
          mo_asset_man   TYPE REF TO ycl_abapgit_gui_asset_manager,
    ...
    METHODS call_page
      IMPORTING ii_page          TYPE REF TO yif_abapgit_gui_page
...
CLASS YCL_ABAPGIT_GUI IMPLEMENTATION.
  ...
  METHOD go_home.
    ...
    on_event( action = |{ yif_abapgit_definitions=>c_action-go_main }| ). " doesn't accept strings directly
  ...
  METHOD handle_action.
    ...
    DATA: lx_exception TYPE REF TO ycx_abapgit_exception,
          li_page      TYPE REF TO yif_abapgit_gui_page,
          lv_state     TYPE i.
    ...
    TRY.
        ...
        CASE lv_state.
          WHEN yif_abapgit_definitions=>c_event_state-re_render.
            render( ).
          WHEN yif_abapgit_definitions=>c_event_state-new_page.
            call_page( li_page ).
          WHEN yif_abapgit_definitions=>c_event_state-new_page_w_bookmark.
            call_page( ii_page = li_page iv_with_bookmark = abap_true ).
          WHEN yif_abapgit_definitions=>c_event_state-new_page_replacing.
            call_page( ii_page = li_page iv_replacing = abap_true ).
          WHEN yif_abapgit_definitions=>c_event_state-go_back.
            back( ).
          WHEN yif_abapgit_definitions=>c_event_state-go_back_to_bookmark.
            back( abap_true ).
          WHEN yif_abapgit_definitions=>c_event_state-no_more_act.
            " Do nothing, handling completed
          WHEN OTHERS.
            ycx_abapgit_exception=>raise( |Unknown action: { iv_action }| ).
        ENDCASE.

      CATCH ycx_abapgit_exception INTO lx_exception.
        ROLLBACK WORK.
        MESSAGE lx_exception TYPE 'S' DISPLAY LIKE 'E'.
      CATCH ycx_abapgit_cancel ##NO_HANDLER.
  ...
  METHOD render.
    ...
    DATA: lv_url  TYPE w3url,
          lo_html TYPE REF TO ycl_abapgit_html.
  ...
  METHOD startup.
    ...
    DATA: lt_events TYPE cntl_simple_events,
          ...
          lt_assets TYPE yif_abapgit_definitions=>tt_web_assets.
