CLASS ycl_abapgit_gui_page_codi_base DEFINITION PUBLIC ABSTRACT INHERITING FROM ycl_abapgit_gui_page.
  PUBLIC SECTION.
    METHODS:
       yif_abapgit_gui_page~on_event
        REDEFINITION.
  ...
  PROTECTED SECTION.
    ...
    METHODS:
      render_result IMPORTING ro_html   TYPE REF TO ycl_abapgit_html
                              iv_result TYPE scir_alvlist,
      jump
        IMPORTING
          is_item       TYPE yif_abapgit_definitions=>ty_item
          is_sub_item   TYPE yif_abapgit_definitions=>ty_item
...
CLASS ycl_abapgit_gui_page_codi_base IMPLEMENTATION.
  ...
  METHOD render_result.
    ...
    IF iv_result-sobjname IS INITIAL OR
      ...
      ro_html->add_a( iv_txt = |{ iv_result-objtype } { iv_result-objname }|
                      ...
                      iv_typ = yif_abapgit_definitions=>c_action_type-sapevent ).
  ...
  METHOD yif_abapgit_gui_page~on_event.
    DATA: ls_item          TYPE yif_abapgit_definitions=>ty_item,
          ls_sub_item      TYPE yif_abapgit_definitions=>ty_item,
    ...
    CASE iv_action.
      ...
      WHEN yif_abapgit_definitions=>c_action-abapgit_home.
        RETURN.
  ...
  METHOD jump.
    DATA: lo_test               TYPE REF TO cl_ci_test_root,
          li_code_inspector     TYPE REF TO yif_abapgit_code_inspector,
    ...
    DATA: ls_item               TYPE yif_abapgit_definitions=>ty_item.
    DATA: ls_sub_item           TYPE yif_abapgit_definitions=>ty_item.
    ...
    TRY.
        IF lv_adt_jump_enabled = abap_true.
          ...
          ycl_abapgit_objects_super=>jump_adt( i_obj_name     = ls_item-obj_name
    ...
    TRY.
      ...
      CATCH cx_root.
        ycx_abapgit_exception=>raise( |Jump to object not supported in your NW release|  ).
    ENDTRY.
