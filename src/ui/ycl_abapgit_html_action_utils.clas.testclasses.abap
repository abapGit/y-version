...
CLASS ltcl_html_action_utils IMPLEMENTATION.
  ...
  METHOD add_field.
    ...
    ycl_abapgit_html_action_utils=>add_field( EXPORTING iv_name = 'NAME' ig_field = 'TEST'
                                      CHANGING  ct_field = lt_fields ).
    ycl_abapgit_html_action_utils=>add_field( EXPORTING iv_name = 'VALUE' ig_field = ls_field
                                      CHANGING  ct_field = lt_fields ).
  ...
  METHOD get_field.
    ...
    ycl_abapgit_html_action_utils=>get_field( EXPORTING iv_name = 'NAME' it_field = lt_fields
...
* file status = '?', used in staging page
  ...
  METHOD _when_fields_are_parsed.
    ...
    mt_parsed_fields = ycl_abapgit_html_action_utils=>parse_fields_upper_case_name( mv_given_parse_string ).
