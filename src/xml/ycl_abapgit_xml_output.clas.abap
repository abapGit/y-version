CLASS ycl_abapgit_xml_output DEFINITION
  PUBLIC
  INHERITING FROM ycl_abapgit_xml
  CREATE PUBLIC.
...
CLASS YCL_ABAPGIT_XML_OUTPUT IMPLEMENTATION.
  ...
  METHOD render.
    ...
    li_git->set_attribute( name = c_attr_version value = yif_abapgit_version=>gc_xml_version ).
