CLASS ycl_abapgit_repo_content_list DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS list
      ...
      RETURNING VALUE(rt_repo_items) TYPE yif_abapgit_definitions=>tt_repo_items
      RAISING   ycx_abapgit_exception.

    METHODS get_log
      RETURNING VALUE(ro_log) TYPE REF TO ycl_abapgit_log.
  PRIVATE SECTION.
    ...
    METHODS build_folders
      ...
      CHANGING  ct_repo_items TYPE yif_abapgit_definitions=>tt_repo_items
      RAISING   ycx_abapgit_exception.
...
CLASS ycl_abapgit_repo_content_list IMPLEMENTATION.
  ...
  METHOD build_folders.
    ...
    LOOP AT ct_repo_items ASSIGNING <ls_item>.
      ...
      IF ycl_abapgit_path=>is_subdir( iv_path = <ls_item>-path  iv_parent = iv_cur_dir ) = abap_true.
  ...
  METHOD build_repo_items_online.
    ...
    DATA: lo_repo_online TYPE REF TO ycl_abapgit_repo_online,
          ls_file        TYPE yif_abapgit_definitions=>ty_repo_file,
    ...
    LOOP AT lt_status ASSIGNING <ls_status>.
      ...
      IF <ls_status>-filename IS NOT INITIAL.
        ...
        IF ls_file-is_changed = abap_true.
          ...
          ycl_abapgit_state=>reduce( EXPORTING iv_cur = ls_file-lstate
                                     CHANGING cv_prev = <ls_repo_item>-lstate ).
          ycl_abapgit_state=>reduce( EXPORTING iv_cur = ls_file-rstate
