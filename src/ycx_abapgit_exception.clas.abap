...
CLASS ycx_abapgit_exception DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS:
      ...
      "! @raising ycx_abapgit_exception | Exception
  ...
  PRIVATE SECTION.
    CONSTANTS:
      gc_generic_error_msg TYPE string VALUE `An error occured (YCX_ABAPGIT_EXCEPTION)` ##NO_TEXT.
ENDCLASS.



CLASS ycx_abapgit_exception IMPLEMENTATION.
  ...
  METHOD raise.
    ...
    RAISE EXCEPTION TYPE ycx_abapgit_exception
      EXPORTING
        textid   = ls_t100_key
        msgv1    = lv_msgv1
        msgv2    = lv_msgv2
