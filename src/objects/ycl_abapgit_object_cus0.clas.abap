CLASS ycl_abapgit_object_cus0 DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_super FINAL.
...
CLASS YCL_ABAPGIT_OBJECT_CUS0 IMPLEMENTATION.
  ...
  METHOD yif_abapgit_object~delete.
    ...
    IF ls_message-msgty <> 'S'.
      ycx_abapgit_exception=>raise( |error from delete CUS0 { mv_img_activity } S_CUS_IMG_ACTIVITY_DELETE| ).
    ENDIF.
