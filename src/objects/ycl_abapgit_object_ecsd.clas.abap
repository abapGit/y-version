CLASS ycl_abapgit_object_ecsd DEFINITION
  PUBLIC
...
CLASS ycl_abapgit_object_ecsd IMPLEMENTATION.
  ...
  METHOD get_upload.
    ...
    CREATE OBJECT ro_upload TYPE ycl_abapgit_ecatt_system_upl.

  ENDMETHOD.

  METHOD get_download.

    CREATE OBJECT ro_download TYPE ycl_abapgit_ecatt_system_downl.
