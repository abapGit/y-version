CLASS ycl_abapgit_object_enho_badi DEFINITION PUBLIC.
...
CLASS ycl_abapgit_object_enho_badi IMPLEMENTATION.
...
* make sure the XML serialization does not dump, field type = N
  ...
  METHOD yif_abapgit_object_enho~deserialize.
    ...
    TRY.
      ...
      CATCH cx_enh_root.
        ycx_abapgit_exception=>raise( 'error deserializing ENHO badi' ).
    ENDTRY.
