...
CLASS ycl_abapgit_object_ecatt_super DEFINITION LOCAL FRIENDS ltcl_changed_by.
...
CLASS ltcl_changed_by DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    DATA:
      ms_given_current_changed  TYPE ycl_abapgit_object_ecatt_super=>ty_last_changed,
      ms_given_last_changed     TYPE ycl_abapgit_object_ecatt_super=>ty_last_changed,
...
CLASS ltcl_changed_by IMPLEMENTATION.
  ...
  METHOD when_changed_is_checked.
    ...
    mv_act_change_more_recent = ycl_abapgit_object_ecatt_super=>is_change_more_recent_than(
