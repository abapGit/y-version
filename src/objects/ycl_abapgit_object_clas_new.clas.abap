"! This class is just a different name for zcl_yabapgit_object_clas.
...
CLASS ycl_abapgit_object_clas_new DEFINITION PUBLIC INHERITING FROM ycl_abapgit_object_clas.
...
CLASS ycl_abapgit_object_clas_new IMPLEMENTATION.

  METHOD get_metadata.
    rs_metadata = super->get_metadata( ).
    rs_metadata-class = 'YCL_ABAPGIT_OBJECT_CLAS'.
  ENDMETHOD.
