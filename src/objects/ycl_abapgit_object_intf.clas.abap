CLASS ycl_abapgit_object_intf DEFINITION PUBLIC FINAL INHERITING FROM ycl_abapgit_objects_program.
  PUBLIC SECTION.
...
CLASS YCL_ABAPGIT_OBJECT_INTF IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    mi_object_oriented_object_fct = ycl_abapgit_oo_factory=>make( ms_item-obj_type ).
  ENDMETHOD.
