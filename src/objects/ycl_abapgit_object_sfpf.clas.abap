CLASS ycl_abapgit_object_sfpf DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_super FINAL.
...
CLASS ycl_abapgit_object_sfpf IMPLEMENTATION.
  ...
  METHOD form_to_xstring.
    ...
    TRY.
      ...
      CATCH cx_fp_api.
        ycx_abapgit_exception=>raise( 'SFPF error, form_to_xstring' ).
    ENDTRY.
  ...
  METHOD load.
    ...
    TRY.
      ...
      CATCH cx_fp_api.
        ycx_abapgit_exception=>raise( 'SFPF error, load' ).
    ENDTRY.
  ...
  METHOD yif_abapgit_object~deserialize.
    ...
    TRY.
        ...
        li_wb_object->free( ).
      CATCH cx_fp_api.
        ycx_abapgit_exception=>raise( 'SFPF error, deserialize' ).
    ENDTRY.
