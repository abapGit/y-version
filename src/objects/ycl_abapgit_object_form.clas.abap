CLASS ycl_abapgit_object_form DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_super FINAL.
  ...
  PRIVATE SECTION.
    ...
    METHODS get_last_changes
      IMPORTING
        iv_form_name           TYPE yif_abapgit_definitions=>ty_item-obj_name
      RETURNING
    ...
    METHODS _save_form
      IMPORTING
        it_lines     TYPE ycl_abapgit_object_form=>tyt_lines
      CHANGING
        cs_form_data TYPE ycl_abapgit_object_form=>tys_form_data.

    METHODS extract_tdlines
      IMPORTING
        is_form_data    TYPE ycl_abapgit_object_form=>tys_form_data
      RETURNING
        VALUE(rt_lines) TYPE ycl_abapgit_object_form=>tyt_lines
      RAISING
    ...
    METHODS find_form
      IMPORTING
        iv_object_name        TYPE yif_abapgit_definitions=>ty_item-obj_name
      RETURNING
        VALUE(rt_text_header) TYPE ycl_abapgit_object_form=>tyt_text_header.

    METHODS _read_form
      IMPORTING
        is_text_header TYPE ycl_abapgit_object_form=>tys_text_header
      EXPORTING
        ev_form_found  TYPE flag
        es_form_data   TYPE ycl_abapgit_object_form=>tys_form_data
        et_lines       TYPE ycl_abapgit_object_form=>tyt_lines.
...
CLASS ycl_abapgit_object_form IMPLEMENTATION.
