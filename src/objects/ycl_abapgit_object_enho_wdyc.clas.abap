CLASS ycl_abapgit_object_enho_wdyc DEFINITION PUBLIC.
...
CLASS ycl_abapgit_object_enho_wdyc IMPLEMENTATION.
...
* lo_wdyconf->set_enhancement_data( )
      ...
      CATCH cx_enh_root.
        ycx_abapgit_exception=>raise( 'error deserializing ENHO wdyconf' ).
    ENDTRY.
