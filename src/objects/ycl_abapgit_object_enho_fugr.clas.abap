CLASS ycl_abapgit_object_enho_fugr DEFINITION PUBLIC.
...
CLASS YCL_ABAPGIT_OBJECT_ENHO_FUGR IMPLEMENTATION.
  ...
  METHOD yif_abapgit_object_enho~deserialize.
    ...
    TRY.
      ...
      CATCH cx_enh_root.
        ycx_abapgit_exception=>raise( |error deserializing ENHO fugrdata { ms_item-obj_name }| ).
    ENDTRY.
