CLASS ycl_abapgit_object_enho_clif DEFINITION PUBLIC.
  ...
  PRIVATE SECTION.
    CLASS-METHODS: serialize_includes
      IMPORTING io_files TYPE REF TO ycl_abapgit_objects_files
                io_clif  TYPE REF TO cl_enh_tool_clif
      RAISING   ycx_abapgit_exception.

ENDCLASS.

CLASS ycl_abapgit_object_enho_clif IMPLEMENTATION.
