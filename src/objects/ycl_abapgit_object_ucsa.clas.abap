CLASS ycl_abapgit_object_ucsa DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_super FINAL.
...
CLASS YCL_ABAPGIT_OBJECT_UCSA IMPLEMENTATION.
  ...
  METHOD yif_abapgit_object~delete.
    ...
    TRY.
        ...
        CALL METHOD lo_persistence->('IF_UCON_SA_PERSIST~DELETE')
          EXPORTING
            version = yif_abapgit_definitions=>c_version-active.
