CLASS ltcl_oo_serialize DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    METHODS:
      ...
      _given_source_is
        IMPORTING
          i_source TYPE LINE OF yif_abapgit_definitions=>ty_string_tt,
      _given_empty_test_include,
      _when_skip_is_calculated,
      _then_should_be_skipped,
      _then_should_not_be_skipped.

    DATA: mo_oo_serializer  TYPE REF TO ycl_abapgit_oo_serializer,
          mt_source         TYPE yif_abapgit_definitions=>ty_string_tt,
