CLASS ycl_abapgit_object_ecvo DEFINITION
  PUBLIC
...
CLASS ycl_abapgit_object_ecvo IMPLEMENTATION.
...
*    rv_object_type = cl_apl_ecatt_const=>obj_type_ecatt_vo.
  ...
  METHOD get_upload.
    ...
    CREATE OBJECT ro_upload TYPE ycl_abapgit_ecatt_val_obj_upl.

  ENDMETHOD.

  METHOD get_download.

    CREATE OBJECT ro_download TYPE ycl_abapgit_ecatt_val_obj_down.
