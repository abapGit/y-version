CLASS ycl_abapgit_object_docv DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_super FINAL.
...
CLASS ycl_abapgit_object_docv IMPLEMENTATION.
  ...
  METHOD yif_abapgit_object~jump.
    ...
    ycx_abapgit_exception=>raise( 'todo, jump DOCV' ).
