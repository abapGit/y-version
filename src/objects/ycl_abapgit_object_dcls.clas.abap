CLASS ycl_abapgit_object_dcls DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_super FINAL.
...
CLASS ycl_abapgit_object_dcls IMPLEMENTATION.
  ...
  METHOD yif_abapgit_object~delete.
    ...
    TRY.
      ...
      CATCH cx_root.
        ycx_abapgit_exception=>raise( 'DCLS error' ).
    ENDTRY.
  ...
  METHOD yif_abapgit_object~jump.
    ...
    TRY.
      ...
      CATCH ycx_abapgit_exception.
        ycx_abapgit_exception=>raise( 'DCLS Jump Error' ).
    ENDTRY.
