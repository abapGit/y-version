CLASS ycl_abapgit_object_jobd DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_super FINAL.
...
CLASS YCL_ABAPGIT_OBJECT_JOBD IMPLEMENTATION.
  ...
  METHOD yif_abapgit_object~delete.
    ...
    TRY.
      ...
      CATCH cx_root.
        ycx_abapgit_exception=>raise( |Error deleting JOBD| ).
    ENDTRY.
  ...
  METHOD yif_abapgit_object~deserialize.
    ...
    TRY.
      ...
      CATCH cx_root.
        ycx_abapgit_exception=>raise( |Error deserializing JOBD| ).
    ENDTRY.
  ...
  METHOD yif_abapgit_object~exists.
    ...
    TRY.
      ...
      CATCH cx_root.
        ycx_abapgit_exception=>raise( |JOBD not supported| ).
    ENDTRY.
  ...
  METHOD yif_abapgit_object~jump.
    ...
    IF sy-subrc <> 0.
      ycx_abapgit_exception=>raise( |Error from TR_OBJECT_JUMP_TO_TOOL, JOBD| ).
    ENDIF.
  ...
  METHOD yif_abapgit_object~serialize.
    ...
    TRY.
      ...
      CATCH cx_root.
        ycx_abapgit_exception=>raise( |Error serializing JOBD| ).
    ENDTRY.
