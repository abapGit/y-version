CLASS ycl_abapgit_object_clas DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_program.
  ...
  PROTECTED SECTION.
    DATA: mi_object_oriented_object_fct TYPE REF TO yif_abapgit_oo_object_fnc,
...
CLASS ycl_abapgit_object_clas IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    CREATE OBJECT mi_object_oriented_object_fct TYPE ycl_abapgit_oo_class_new.
  ENDMETHOD.

  METHOD deserialize_abap.
* same as in ycl_abapgit_object_clas, but without "mo_object_oriented_object_fct->add_to_activation_list"
    ...
    DATA: ls_vseoclass             TYPE vseoclass,
          ...
          lt_descriptions          TYPE yif_abapgit_definitions=>ty_seocompotx_tt,
          ls_class_key             TYPE seoclskey,
          lt_attributes            TYPE yif_abapgit_definitions=>ty_obj_attribute_tt.
  ...
  METHOD serialize_xml.
    ...
    DATA: ls_vseoclass    TYPE vseoclass,
          ...
          lt_sotr         TYPE yif_abapgit_definitions=>ty_sotr_tt,
