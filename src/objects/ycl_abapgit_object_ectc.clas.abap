CLASS ycl_abapgit_object_ectc DEFINITION
  PUBLIC
...
CLASS ycl_abapgit_object_ectc IMPLEMENTATION.
  ...
  METHOD get_upload.
    ...
    CREATE OBJECT ro_upload TYPE ycl_abapgit_ecatt_config_upl.

  ENDMETHOD.

  METHOD get_download.

    CREATE OBJECT ro_download TYPE ycl_abapgit_ecatt_config_downl.
