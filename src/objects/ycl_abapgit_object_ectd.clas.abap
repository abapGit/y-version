CLASS ycl_abapgit_object_ectd DEFINITION
  PUBLIC
...
CLASS ycl_abapgit_object_ectd IMPLEMENTATION.
  ...
  METHOD get_upload.
    ...
    CREATE OBJECT ro_upload TYPE ycl_abapgit_ecatt_data_upload.

  ENDMETHOD.

  METHOD get_download.

    CREATE OBJECT ro_download TYPE ycl_abapgit_ecatt_data_downl.
