CLASS ycl_abapgit_object_para DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_super FINAL.
...
CLASS ycl_abapgit_object_para IMPLEMENTATION.
...
* see fm RS_PARAMETER_ADD and RS_PARAMETER_EDIT
    ...
    CALL FUNCTION 'RS_CORR_INSERT'
      ...
      EXCEPTIONS
        ...
        OTHERS              = 4.
    IF sy-subrc <> 0.
      ycx_abapgit_exception=>raise( 'error from RS_CORR_INSERT, PARA' ).
    ENDIF.
  ...
  METHOD yif_abapgit_object~delete.
    ...
    CALL FUNCTION 'RS_ACCESS_PERMISSION'
      ...
      EXCEPTIONS
        ...
        OTHERS                   = 10.
    IF sy-subrc <> 0.
      ycx_abapgit_exception=>raise( 'error from RS_PRAMETER_DELETE' ).
    ENDIF.
    ...
    SELECT COUNT(*) FROM cross WHERE ( type = 'P' OR
                              ...
                              AND name   = lv_paramid.
    IF sy-subrc = 0.
      ycx_abapgit_exception=>raise( 'PARA: Parameter is still used' ).
    ELSE.
