CLASS ycl_abapgit_object_enho_wdyn DEFINITION PUBLIC.
...
CLASS YCL_ABAPGIT_OBJECT_ENHO_WDYN IMPLEMENTATION.
  ...
  METHOD yif_abapgit_object_enho~deserialize.
    ...
    TRY.
      ...
      CATCH cx_root.
        ycx_abapgit_exception=>raise( |error deserializing ENHO wdyn { ms_item-obj_name }| ).
    ENDTRY.
  ...
  METHOD yif_abapgit_object_enho~serialize.
    ...
    TRY.
      ...
      CATCH cx_enh_not_found.
        ycx_abapgit_exception=>raise( |error serializing ENHO wdyn { ms_item-obj_name }| ).
    ENDTRY.
