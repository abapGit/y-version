CLASS ycl_abapgit_object_tabl_valid DEFINITION PUBLIC FINAL.
  PUBLIC SECTION.
    METHODS validate
      IMPORTING
        io_remote_version TYPE REF TO ycl_abapgit_xml_input
...
CLASS ycl_abapgit_object_tabl_valid IMPLEMENTATION.
