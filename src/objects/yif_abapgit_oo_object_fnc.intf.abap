INTERFACE yif_abapgit_oo_object_fnc PUBLIC.
  ...
  METHODS:
    create
      IMPORTING
        ...
        it_attributes TYPE yif_abapgit_definitions=>ty_obj_attribute_tt OPTIONAL
      CHANGING
    ...
    update_descriptions
      IMPORTING
        is_key          TYPE seoclskey
        it_descriptions TYPE yif_abapgit_definitions=>ty_seocompotx_tt,
    ...
    create_sotr
      IMPORTING
        iv_package TYPE devclass
        it_sotr    TYPE yif_abapgit_definitions=>ty_sotr_tt
      RAISING
        ycx_abapgit_exception,
    ...
    read_sotr
      IMPORTING
        iv_object_name TYPE sobj_name
      RETURNING
        VALUE(rt_sotr) TYPE yif_abapgit_definitions=>ty_sotr_tt
      RAISING
        ycx_abapgit_exception,
    read_descriptions
      IMPORTING
      ...
      RETURNING
        VALUE(rt_descriptions) TYPE yif_abapgit_definitions=>ty_seocompotx_tt,
    delete
      IMPORTING
    ...
    read_attributes
      ...
      RETURNING
        VALUE(rt_attributes) TYPE yif_abapgit_definitions=>ty_obj_attribute_tt.
ENDINTERFACE.
