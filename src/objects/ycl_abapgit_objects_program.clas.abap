CLASS ycl_abapgit_objects_program DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_super.
  ...
  PUBLIC SECTION.
    ...
    METHODS serialize_program
      IMPORTING io_xml     TYPE REF TO ycl_abapgit_xml_output OPTIONAL
  ...
  PROTECTED SECTION.
    ...
    CLASS-METHODS:
      add_tpool
        ...
        RETURNING VALUE(rt_tpool) TYPE yif_abapgit_definitions=>ty_tpool_tt,
      read_tpool
        IMPORTING it_tpool        TYPE yif_abapgit_definitions=>ty_tpool_tt
        RETURNING VALUE(rt_tpool) TYPE yif_abapgit_definitions=>ty_tpool_tt.
  ...
  PRIVATE SECTION.
    ...
    CLASS-METHODS auto_correct_cua_adm
      IMPORTING
        is_cua TYPE ycl_abapgit_objects_program=>ty_cua
      CHANGING
...
CLASS ycl_abapgit_objects_program IMPLEMENTATION.
  ...
  METHOD is_cua_locked.
    ...
    DATA: lv_object TYPE eqegraarg,
          ls_cua    TYPE ycl_abapgit_objects_program=>ty_cua.
  ...
  METHOD is_any_dynpro_locked.
    ...
    DATA: lt_dynpros TYPE ycl_abapgit_objects_program=>ty_dynpro_tt,
          lv_object  TYPE seqg3-garg.

    FIELD-SYMBOLS: <ls_dynpro> TYPE ycl_abapgit_objects_program=>ty_dynpro.
  ...
  METHOD serialize_program.
    ...
    ycl_abapgit_language=>set_current_language( mv_language ).
    ...
    IF sy-subrc = 2.
      ycl_abapgit_language=>restore_login_language( ).
      RETURN.
    ELSEIF sy-subrc <> 0.
      ycl_abapgit_language=>restore_login_language( ).
      ycx_abapgit_exception=>raise( 'Error reading program' ).
    ENDIF.
    ...
    IF lv_exists = abap_true.
      ...
      IF sy-subrc <> 0.
        ...
        IF sy-msgid = 'EU' AND sy-msgno = '510'.
          ycx_abapgit_exception=>raise( 'User is currently editing program' ).
        ELSE.
          ycx_abapgit_exception=>raise( 'PROG, error updating' ).
        ENDIF.
      ENDIF.
...
* function module RPY_PROGRAM_INSERT cannot handle function group includes
      ...
      IF sy-subrc <> 0.
        ycx_abapgit_exception=>raise( 'error from INSERT REPORT .. EXTENSION TYPE' ).
      ENDIF.
    ELSE.
      INSERT REPORT is_progdir-name
        FROM it_source
      ...
      IF sy-subrc <> 0.
        ycx_abapgit_exception=>raise( 'error from INSERT REPORT' ).
      ENDIF.
    ENDIF.
    ...
    IF NOT it_tpool[] IS INITIAL.
      INSERT TEXTPOOL is_progdir-name
        ...
        STATE 'I'.
      IF sy-subrc <> 0.
        ycx_abapgit_exception=>raise( 'error from INSERT TEXTPOOL' ).
      ENDIF.
    ENDIF.
    ...
    CALL FUNCTION 'READ_PROGDIR'
      ...
      EXCEPTIONS
        ...
        OTHERS     = 2.
    IF sy-subrc <> 0.
      ycx_abapgit_exception=>raise( 'not found in PROGDIR' ).
    ENDIF.
...
* todo, package?
    ...
    CALL FUNCTION 'UPDATE_PROGDIR'
      ...
      EXCEPTIONS
        ...
        OTHERS       = 2.
    IF sy-subrc <> 0.
      ycx_abapgit_exception=>raise( 'PROG, error inserting' ).
    ENDIF.
...
* function module UPDATE_PROGDIR does not update VARCL
    ...
    ycl_abapgit_objects_activation=>add(
      iv_type = 'REPS'
  ...
  METHOD serialize_cua.
    ...
    CALL FUNCTION 'RS_CUA_INTERNAL_FETCH'
      ...
      EXCEPTIONS
        ...
        OTHERS          = 3.
    IF sy-subrc > 1.
      ycx_abapgit_exception=>raise( |error from RS_CUA_INTERNAL_FETCH, { sy-subrc }| ).
    ENDIF.
  ...
  METHOD serialize_dynpros.
    ...
    CALL FUNCTION 'RS_SCREEN_LIST'
      ...
      EXCEPTIONS
        ...
        OTHERS    = 2.
    IF sy-subrc = 2.
      ycx_abapgit_exception=>raise( 'error from screen_list' ).
    ENDIF.
    ...
    LOOP AT lt_d020s ASSIGNING <ls_d020s>
      ...
      CALL FUNCTION 'RPY_DYNPRO_READ'
        ...
        EXCEPTIONS
          ...
          OTHERS               = 4.
      IF sy-subrc <> 0.
        ycx_abapgit_exception=>raise( |Error while reading dynpro: { sy-subrc }| ).
      ENDIF.
...
* the program to dump since it_dynpros cannot be changed
    LOOP AT it_dynpros INTO ls_dynpro.
      ...
      IF sy-subrc <> 2 AND sy-subrc <> 0.
        ycx_abapgit_exception=>raise( |error from RPY_DYNPRO_INSERT: { sy-subrc }| ).
      ENDIF.
* todo, RPY_DYNPRO_UPDATE?
  ...
  METHOD deserialize_cua.
    ...
    IF sy-subrc <> 0.
      ycx_abapgit_exception=>raise( 'not found in tadir' ).
    ENDIF.
...
* if moving code from SAPlink, see https://github.com/larshp/abapGit/issues/562
      ycx_abapgit_exception=>raise( 'error from RS_CUA_INTERNAL_WRITE' ).
    ENDIF.
