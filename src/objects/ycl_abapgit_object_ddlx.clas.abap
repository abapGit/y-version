CLASS ycl_abapgit_object_ddlx DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_super FINAL.
...
CLASS ycl_abapgit_object_ddlx IMPLEMENTATION.
  ...
  METHOD get_persistence.
    ...
    TRY.
      ...
      CATCH cx_root.
        ycx_abapgit_exception=>raise( `DDLX not supported` ).
    ENDTRY.
  ...
  METHOD yif_abapgit_object~jump.
    ...
    TRY.
      ...
      CATCH ycx_abapgit_exception.
        ycx_abapgit_exception=>raise( 'DDLX Jump Error' ).
    ENDTRY.
