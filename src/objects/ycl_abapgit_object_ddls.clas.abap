CLASS ycl_abapgit_object_ddls DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_super FINAL.
...
CLASS YCL_ABAPGIT_OBJECT_DDLS IMPLEMENTATION.
  ...
  METHOD open_adt_stob.
    ...
    TRY.
      ...
      CATCH cx_root.
        ycx_abapgit_exception=>raise( 'DDLS Jump Error' ).
    ENDTRY.
    ...
    TRY.
        CALL METHOD lo_ddl->('IF_DD_DDL_HANDLER~DELETE')
          EXPORTING
            name = ms_item-obj_name.
      CATCH cx_root.
        ycx_abapgit_exception=>raise( 'DDLS error deleting' ).
    ENDTRY.
    ...
    TRY.
        ...
        CALL METHOD lo_ddl->('IF_DD_DDL_HANDLER~WRITE_TADIR')
          EXPORTING
            ...
            prid       = 0.
      CATCH cx_root.
        ycx_abapgit_exception=>raise( 'DDLS error writing TADIR' ).
    ENDTRY.
    ...
    TRY.
        CALL METHOD lo_ddl->('IF_DD_DDL_HANDLER~READ')
          ...
          IMPORTING
            ddddlsrcv_wa = <lg_data>.
      CATCH cx_root.
        ycx_abapgit_exception=>raise( 'DDLS error reading' ).
    ENDTRY.
