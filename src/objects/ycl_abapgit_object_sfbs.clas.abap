CLASS ycl_abapgit_object_sfbs DEFINITION PUBLIC INHERITING FROM ycl_abapgit_objects_super FINAL.
...
CLASS YCL_ABAPGIT_OBJECT_SFBS IMPLEMENTATION.
  ...
  METHOD get.
    ...
    TRY.
      ...
      CATCH cx_pak_invalid_data cx_pak_invalid_state cx_pak_not_authorized.
        ycx_abapgit_exception=>raise( 'Error from CL_SFW_BFS=>GET_BFS' ).
    ENDTRY.
  ...
  METHOD yif_abapgit_object~delete.
    ...
    IF sy-subrc = 0.
      ycx_abapgit_exception=>raise( 'Error deleting SFBS' ).
    ENDIF.
  ...
  METHOD yif_abapgit_object~deserialize.
    ...
    TRY.
      ...
      CATCH cx_pak_not_authorized cx_pak_invalid_state cx_pak_invalid_data.
        ycx_abapgit_exception=>raise( 'error in CL_SFW_BFS=>CREATE_BFS' ).
    ENDTRY.
