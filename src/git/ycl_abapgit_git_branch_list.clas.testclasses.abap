...
CLASS ycl_abapgit_git_branch_list DEFINITION LOCAL FRIENDS ltcl_parse.
...
CLASS ltcl_parse IMPLEMENTATION.
  ...
  METHOD parse.
    ...
    DATA: lv_data TYPE string,
          lt_list TYPE yif_abapgit_definitions=>ty_git_branch_list_tt.


    CONCATENATE LINES OF mt_data INTO lv_data SEPARATED BY yif_abapgit_definitions=>c_newline.

    ycl_abapgit_git_branch_list=>parse_branch_list(
      EXPORTING
        iv_data = lv_data
      IMPORTING
        et_list = lt_list ).
