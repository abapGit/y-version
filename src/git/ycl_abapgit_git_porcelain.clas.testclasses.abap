...
CLASS ycl_abapgit_git_porcelain DEFINITION LOCAL FRIENDS ltcl_git_porcelain.
...
CLASS ltcl_git_porcelain DEFINITION FOR TESTING RISK LEVEL HARMLESS DURATION SHORT FINAL.
  ...
  PRIVATE SECTION.
    ...
    DATA: mt_expanded TYPE yif_abapgit_definitions=>ty_expanded_tt,
          mt_trees    TYPE ycl_abapgit_git_porcelain=>ty_trees_tt.
...
CLASS ltcl_git_porcelain IMPLEMENTATION.
  ...
  METHOD append.
    ...
    <ls_expanded>-sha1  = 'a'.
    <ls_expanded>-chmod = yif_abapgit_definitions=>c_chmod-file.
  ...
  METHOD single_file.
    ...
    mt_trees = ycl_abapgit_git_porcelain=>build_trees( mt_expanded ).
