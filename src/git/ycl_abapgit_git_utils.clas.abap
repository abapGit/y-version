CLASS ycl_abapgit_git_utils DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS YCL_ABAPGIT_GIT_UTILS IMPLEMENTATION.
...
* hmm, can this be done easier?
    ...
    TRY.
      ...
      CATCH cx_sy_conversion_codepage.
        ycx_abapgit_exception=>raise( 'error converting to hex, LENGTH_UTF8_HEX' ).
    ENDTRY.
  ...
  METHOD pkt_string.
    ...
    IF lv_len >= 255.
      ycx_abapgit_exception=>raise( 'PKT, todo' ).
    ENDIF.
