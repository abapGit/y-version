CLASS ycl_abapgit_http_digest DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS YCL_ABAPGIT_HTTP_DIGEST IMPLEMENTATION.
  ...
  METHOD md5.
    ...
    lv_xstr = ycl_abapgit_convert=>string_to_xstring_utf8( iv_data ).
    ...
    CALL FUNCTION 'CALCULATE_HASH_FOR_RAW'
      ...
      EXCEPTIONS
        ...
        OTHERS         = 4.
    IF sy-subrc <> 0.
      ycx_abapgit_exception=>raise( 'error from CALCULATE_HASH_FOR_RAW' ).
    ENDIF.
