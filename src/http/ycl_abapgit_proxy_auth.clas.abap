CLASS ycl_abapgit_proxy_auth DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    CLASS-METHODS: enter RAISING ycx_abapgit_exception.

ENDCLASS.



CLASS YCL_ABAPGIT_PROXY_AUTH IMPLEMENTATION.
  ...
  METHOD enter.
    ...
    IF gv_username IS INITIAL OR gv_password IS INITIAL.
      ycx_abapgit_exception=>raise( 'Proxy auth failed' ).
    ENDIF.
