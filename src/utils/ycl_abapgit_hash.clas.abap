CLASS ycl_abapgit_hash DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS adler32
      ...
      RETURNING
        VALUE(rv_checksum) TYPE yif_abapgit_definitions=>ty_adler32 .
    CLASS-METHODS sha1
      IMPORTING
...
CLASS YCL_ABAPGIT_HASH IMPLEMENTATION.
  ...
  METHOD sha1_raw.
    ...
    CALL FUNCTION 'CALCULATE_HASH_FOR_RAW'
      ...
      EXCEPTIONS
        ...
        OTHERS         = 4.
    IF sy-subrc <> 0.
      ycx_abapgit_exception=>raise( 'Error while calculating SHA1' ).
    ENDIF.
