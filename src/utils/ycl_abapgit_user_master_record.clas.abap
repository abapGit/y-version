CLASS ycl_abapgit_user_master_record DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS:
      get_instance
        IMPORTING
          !iv_user       TYPE uname
        RETURNING
          VALUE(ro_user) TYPE REF TO ycl_abapgit_user_master_record.
    ...
    METHODS:
      ...
      get_name
        RETURNING
          VALUE(rv_name) TYPE yif_abapgit_definitions=>ty_git_user-name,

      get_email
        RETURNING
          VALUE(rv_email) TYPE yif_abapgit_definitions=>ty_git_user-email.

  PRIVATE SECTION.
    TYPES:
      BEGIN OF ty_user,
        user   TYPE uname,
        o_user TYPE REF TO ycl_abapgit_user_master_record,
      END OF ty_user.
    ...
    DATA:
      ms_user TYPE yif_abapgit_definitions=>ty_git_user.

ENDCLASS.



CLASS ycl_abapgit_user_master_record IMPLEMENTATION.
