...
CLASS ycl_abapgit_news DEFINITION LOCAL FRIENDS ltcl_relevant.
...
CLASS ltcl_relevant IMPLEMENTATION.
  ...
  METHOD test01.
    ...
    lv_relevant = ycl_abapgit_news=>is_relevant( 'https://github.com/larshp/abapGit.git' ).
  ...
  METHOD test02.
    ...
    lv_relevant = ycl_abapgit_news=>is_relevant( 'https://github.com/larshp/abapGit' ).
  ...
  METHOD test03.
    ...
    lv_relevant = ycl_abapgit_news=>is_relevant( 'https://github.com/larshp/something' ).
...
CLASS ycl_abapgit_news DEFINITION LOCAL FRIENDS ltcl_news.
...
CLASS ltcl_news IMPLEMENTATION.
  ...
  METHOD version_to_numeric.
    ...
    lv_version_act = ycl_abapgit_news=>version_to_numeric( '1.23.10' ).
  ...
  METHOD compare_versions.
    ...
    lv_result = ycl_abapgit_news=>compare_versions( iv_a = '1.28.10' iv_b = '1.23.10' ).
    ...
    lv_result = ycl_abapgit_news=>compare_versions( iv_a = '1.28.10' iv_b = '2.23.10' ).
    ...
    lv_result = ycl_abapgit_news=>compare_versions( iv_a = '1.28.10' iv_b = '1.28.10' ).
  ...
  METHOD normalize_version.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = ycl_abapgit_news=>normalize_version( '1.28.10' )
      exp = '1.28.10' ).

    cl_abap_unit_assert=>assert_equals(
      act = ycl_abapgit_news=>normalize_version( 'v1.28.10' )
      exp = '1.28.10' ).

    cl_abap_unit_assert=>assert_equals(
      act = ycl_abapgit_news=>normalize_version( 'b1.28.10' )
      exp = '' ).

    cl_abap_unit_assert=>assert_equals(
      act = ycl_abapgit_news=>normalize_version( 'x.y.z' )
      exp = '' ).
  ...
  METHOD parse_line.
    ...
    DATA: ls_log TYPE ycl_abapgit_news=>ty_log.

    ls_log = ycl_abapgit_news=>parse_line(
      iv_line            = '======'
  ...
  METHOD parse.
    ...
    DATA: lt_log_exp TYPE ycl_abapgit_news=>tt_log,
          lt_log_act TYPE ycl_abapgit_news=>tt_log,
    ...
    lt_log_act = ycl_abapgit_news=>parse( it_lines = lt_lines iv_current_version = '1.26.01' ).
    ...
    lt_log_act = ycl_abapgit_news=>parse( it_lines = lt_lines iv_current_version = '1.27.00' ).
    cl_abap_unit_assert=>assert_equals( exp = lt_log_exp
                                        act = lt_log_act
    ...
    " Case 1. Test parsing of data
    lt_log_act = ycl_abapgit_news=>parse( it_lines = lt_lines iv_current_version = '1.28.00' ).
    cl_abap_unit_assert=>assert_equals( exp = lt_log_exp
                                        act = lt_log_act
