...
CLASS ycl_abapgit_syntax_highlighter DEFINITION LOCAL FRIENDS ltcl_syntax_cases.
...
CLASS ltcl_syntax_cases DEFINITION FINAL FOR TESTING RISK LEVEL HARMLESS
  ...
  PRIVATE SECTION.
    ...
    DATA:
      mt_after_parse  TYPE ycl_abapgit_syntax_highlighter=>ty_match_tt,
      mt_after_order  TYPE ycl_abapgit_syntax_highlighter=>ty_match_tt,
      mt_after_extend TYPE ycl_abapgit_syntax_highlighter=>ty_match_tt,
      ms_match        TYPE ycl_abapgit_syntax_highlighter=>ty_match.
...
CLASS ltcl_syntax_cases IMPLEMENTATION.
  ...
  METHOD do_test.
    ...
    DATA: lt_matches_act TYPE ycl_abapgit_syntax_highlighter=>ty_match_tt,
          lo_syntax      TYPE REF TO ycl_abapgit_syntax_highlighter.


    lo_syntax = ycl_abapgit_syntax_highlighter=>create( iv_filename ).
...
CLASS ycl_abapgit_syntax_highlighter DEFINITION LOCAL FRIENDS ltcl_syntax_basic_logic.
...
CLASS ltcl_syntax_basic_logic DEFINITION FINAL FOR TESTING RISK LEVEL HARMLESS
  ...
  PRIVATE SECTION.
    ...
    DATA mo_syntax_highlighter TYPE REF TO ycl_abapgit_syntax_highlighter.
...
CLASS ltcl_syntax_basic_logic IMPLEMENTATION.
  ...
  METHOD setup.
    mo_syntax_highlighter = ycl_abapgit_syntax_highlighter=>create( '*.abap' ).
  ENDMETHOD.
  ...
  METHOD apply_style.
    ...
    lv_line_act = mo_syntax_highlighter->apply_style( iv_line  = 'CALL FUNCTION' "#EC NOTEXT
                                   iv_class = ycl_abapgit_syntax_abap=>c_css-keyword ).
